...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/daisuke8000/example-ec-platform/gen/health/v1"
	http "net/http"
	strings "strings"
)
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_health_v1_health_service_proto.Services().ByName("HealthService").Methods()
